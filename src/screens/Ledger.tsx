  ...
  const filterPanel = (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      <div className="panel" style={{ padding: '12px 14px' }}>
        ...
        <div style={{ fontFamily: 'var(--mono)', fontSize: 9.5, letterSpacing: '0.18em', color: 'var(--ink-4)', marginBottom: 8 }}>DIRECTION</div>
      ...
      {txs.length > 0 && (
        <div className="panel" style={{ padding: '12px 14px' }}>
          <span className="brackets"><i /></span>
          <div style={{ fontFamily: 'var(--mono)', fontSize: 9.5, letterSpacing: '0.18em', color: 'var(--ink-4)', marginBottom: 10 }}>◆ STATS · FILTERED</div>
          {[
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 280px', gap: 14, padding: 14, alignItems: 'start' }}>
        <div>
          <div style={{
            ...
            <span>◆ LEDGER · TODAS LAS ENTRADAS</span>
    ...
    <div className="scroll" style={{ padding: '0 14px 20px' }}>
      ...
      {txs.length > 0 && (
        <div style={{ display: 'flex', gap: 20, marginTop: 14, fontFamily: 'var(--mono)', fontSize: 11 }}>
          ...
          <span>
            <span style={{ color: 'var(--ink-4)', fontSize: 9, letterSpacing: '0.18em', display: 'block', marginBottom: 2 }}>NET</span>
      ...
      <SectionLabel right="ALL">LEDGER · REGISTRO</SectionLabel>
      {txList}
      <div style={{ height: 24 }} />
    </div>
  )
